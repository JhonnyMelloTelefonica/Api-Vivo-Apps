...
--values (NEWID(),64960,7,'2024-10-15 10:29:52.7162834')
...
values (
'VIVOX_CARDAPIO_DIGITAL','Perfil destinado aos usuário comuns do módulo Cardapio Digital',null
)

insert into PERFIL_PLATAFORMAS_VIVO
values (
'VIVOX_CARDAPIO_DIGITAL_ADM','Perfil destinado aos usuário que fazem a gestão do módulo Cardapio Digital',null
)
...
select * from CONTROLE_DE_DEMANDAS_CAMPOS_FILA where ID_FILA IN (573,574)
    ...
    where B.CAMPO LIKE '%DDD%' AND A.MATRICULA_SOLICITANTE <> 151191
